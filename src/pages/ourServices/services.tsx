...
const serviceCards=[
  {
    data:{
      span:"Academic",
          ...
          description:"Start your journey with us. Apply for undergraduate and postgraduate programs, track your application status, and manage enrollment documents.",
  ...
  return (
    <>
      ...
      <div className='p-4 w-full flex flex-col gap-6'>
        ...
        Comprehensive support and resources designed to assist international students
throughout their academic journey at Minia University.</p>
      </div>
